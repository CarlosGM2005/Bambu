...
export class CarritoCompraComponent {
  listaProductos = [
    ...
    { nombre: 'ARROZ CON SOJA', tipo: 'ARROZ Y NOODLES', precio: '5.90€', urlImg: 'assets/images/productos/Arroz_con_Soja.png', urlIcono: 'assets/images/iconos/carrito-aniadir.png' },
    { nombre: 'ARROZ VEGETAL', tipo: 'ARROZ Y NOODLES', precio: '5.90€', urlImg: 'assets/images/productos/ARROZ_VEGETAL.jpg', urlIcono: 'assets/images/iconos/carrito-aniadir.png' },
    { nombre: 'NOODLES VEGETAL', tipo: 'ARROZ Y NOODLES', precio: '5.90€', urlImg: 'assets/images/productos/NOODLES.jpg', urlIcono: 'assets/images/iconos/carrito-aniadir.png' },
    { nombre: 'RAMEN CERDO', tipo: 'ARROZ Y NOODLES', precio: '8.90€', urlImg: 'assets/images/productos/Ramen_Cerdo.png', urlIcono: 'assets/images/iconos/carrito-aniadir.png' },
    { nombre: 'RAMEN YASAI VEGETAL', tipo: 'ARROZ Y NOODLES', precio: '7.95€', urlImg: 'assets/images/productos/Ramen_Yasai.png', urlIcono: 'assets/images/iconos/carrito-aniadir.png' },
  ];
